...
printf("************************************************************\n");
printf("     Built for 64 bit Windows by Convergent Mechanical\n");
printf("       For the latest version go to: bConverged.com\n");
printf("************************************************************\n\n");
printf("You are using an executable made on Fri May  1 09:38:01 PDT 2015\n");
fflush(stdout);
